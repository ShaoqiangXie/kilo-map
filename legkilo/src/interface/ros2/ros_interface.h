...
class RosInterface {
   ...
   private:
    ...
    void livoxV1LidarCallBack(ros_compat::LivoxCustomMsgV1ConstPtr msg);
    ...
    rclcpp::Subscription<ros_compat::LivoxCustomMsgV1>::SharedPtr sub_livox_v1_lidar_raw_;
